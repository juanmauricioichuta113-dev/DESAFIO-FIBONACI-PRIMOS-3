...
* **Nombre del Estudiante:** JUAN MAURICIO LAURA ICHUTA
* **Carrera:** Informatica
* **Materia / Curso:** Programación Web 1
* **Título del Proyecto:** Matemáticas que resuelven problemas: Fibonacci y Números Primos en la vida real
* **Enlace del Repositorio Git:** https://github.com/juanmauricioichuta113-dev/DESAFIO-FIBONACI-PRIMOS-3.git
* **Enlace de la página publicada:** https://juanmauricioichuta113-dev.github.io/DESAFIO-FIBONACI-PRIMOS-3/
---
...
🌿 Ejercicio 1: Sucesión de Fibonacci en la Naturaleza
1. ¿Qué problema real va a resolver?
Modela dinámicas de crecimiento biológico y distribución espacial óptima de recursos (filotaxis). Permite simular y predecir de forma interactiva el incremento controlado de poblaciones botánicas o biológicas y la disposición de las hojas en un tallo para maximizar la captura de luz solar y recursos del entorno.
